...
export const metadata: Metadata = {
  title: "隐私协议 · 东方命理 AI 平台",
  description: "守护你的八字隐私与个人信息",
};
      ...
      <section className="px-6 pb-20 sm:px-10">
        <div className="mx-auto max-w-4xl space-y-12 rounded-3xl border border-white/10 bg-white/5 p-10 shadow-xl shadow-amber-500/20">
          <article className="space-y-6 text-sm leading-7 text-slate-200">
            <h2 className="text-2xl font-semibold text-white">1. 信息收集范围</h2>
            <p>
            ...
            <h2 className="pt-4 text-2xl font-semibold text-white">2. 信息使用方式</h2>
            <p>
              我们使用这些信息用于账号注册、命盘生成、运势提醒、功能优化及安全风控。未经你的同意，我们不会将个人信息用于商业推广或出售给第三方，并将对外共享控制在合法合规范围内。
            </p>
            <h2 className="pt-4 text-2xl font-semibold text-white">3. 存储与安全</h2>
            <p>
              所有数据存储在加密的数据库中，敏感字段（例如密码、验证码）会进行哈希或加密处理。我们实施访问控制、日志审计与漏洞检测，避免数据泄露、篡改或丢失。
            </p>
            <h2 className="pt-4 text-2xl font-semibold text-white">4. 第三方服务</h2>
            <p>
              Google、GitHub 登录以及短信服务将遵循各自的隐私政策。你在授权登录时，可随时取消授权；短信验证码仅用于登录验证，不会目的外使用。
            </p>
            <h2 className="pt-4 text-2xl font-semibold text-white">5. 用户权利</h2>
            <p>
              你可以随时访问、更新或删除账号信息，申请注销账号，并导出你的命理数据。在合理验证身份后，我们会在法定期限内处理。
            </p>
            <h2 className="pt-4 text-2xl font-semibold text-white">6. 联系方式</h2>
            <p>

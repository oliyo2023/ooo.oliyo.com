  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="注册东方命理 AI 平台，保存命盘、开启云端同步与运势提醒。" />
        <meta property="og:title" content="注册东方命理 AI 平台" />
        <meta property="og:description" content="创建账号，生成专属命盘并解锁 AI 行运指引。" />
        ...
        <div class="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-white/5 p-10 shadow-xl shadow-amber-500/20">
          <form class="space-y-6">
            ...
            <label class="flex items-start gap-3 text-left text-sm text-slate-200">
              ...
              我同意 <a class="mx-1 text-amber-200 underline-offset-2 hover:underline" href="/privacy">《隐私协议》</a> 与 <a class="mx-1 text-amber-200 underline-offset-2 hover:underline" href="/terms">《用户守则》</a>，授权平台进行命盘生成与运势分析。
            </label>
            <button
              type="submit"
          ...
          <div class="mt-8 rounded-2xl border border-amber-300/20 bg-black/30 p-6 text-left text-sm text-slate-200">
            <h2 class="text-lg font-semibold text白色">注册后你将获得</h2>
      ...
      <footer class="px-6 pb-12 sm:px-10">
        <div class="mx-auto max-w-4xl rounded-3xl border border-white/10 bg-gradient-to-r from-white/10 via-transparent to-white/10 p-8 text-center">
          <p class="text-sm text-slate-200">
            已注册的用户可直接 <a class="text-amber-200 underline-offset-2 hover:underline" href="/login">前往登录</a>，继续探索个人命理旅程。
          </p>
        </div>
      </footer>
    </main>
